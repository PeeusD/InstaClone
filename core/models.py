...
class Post(models.Model):
    ...
    user = models.ForeignKey(User, on_delete= models.PROTECT, editable=False ) #adds _id succesive to fieldname in admin d-board when using foreign key; editable false means uneditable field 
